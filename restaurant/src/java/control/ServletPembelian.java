    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(aksi !=null){
                ...
                men.setHarga(request.getParameter("ename"));
                men.setQty(request.getParameter("qty_beli"));
                men.setSubtotal(request.getParameter("sub_beli"));
                switch(aksi){
                    case "Simpan":
                        pstmt=kon.conn.prepareStatement("INSERT INTO sementara values('"+men.getNobeli()+"','"
                                + men.getKodemenu()+"','"
                                + men.getQty()+"','"
                                + men.getSubtotal()+"')");
                        ...
                        pstmt2=kon.conn.prepareStatement("INSERT INTO detail_pembelian values('"+men.getNobeli()+"','"
                                + men.getKodemenu()+"','"
                                + men.getHarga()+"','"
                                + men.getQty()+"','"
                                + men.getSubtotal()+"')");
