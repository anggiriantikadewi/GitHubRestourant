...
public final class newjsp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <table>\n");
      out.write("                <tr><div>\n");
      out.write("                    <td><label for=\"inputEmail3\" class=\"col-sm-2 control-label\">Kode Bahan</label></td>\n");
      ...
      out.write("                            ");
                                ...
                                try {
                                    ...
                                    while (rs.next()) {
                                        if (rs.first() == false) {
                                            out.println("<input type='text' class='form-control' id='inputEmail3' readonly value='BOOO1' name='kodebahan' >");
                                        } else {
                                            rs.last();
                                            ...
                                            out.println("<input type='text' class='form_control'id='input Email3' readyonly value='" + nomerkm + "' name='kodebahan'>");
                                        }
                                    }
                                } catch (Exception e) {
                                    out.println(e);
